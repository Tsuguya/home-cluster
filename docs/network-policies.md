...
| **mgr** | all ceph daemons, csi-rbd-ctrlplugin, remote-node → 6800; ingress → 7000 (dashboard); prometheus (monitoring) → 9283 | DNS, kube-apiserver, mon:3300/6789, mgr (self):6800, osd:6800-6806 |
